  ...
  return (
    <>
      ...
      <div className=" h-screen w-screen z-20 flex justify-center items-center fixed">
        <div
          dir="rtl"
          className=" bg-white flex flex-col justify-center align-middle rounded-registerRad shadow-registerShadow p-6 gap-7"
        >
          <p className="h-50 font-dana font-semibold text-3xl leading-50 text-right text-black flex-none order-0">
          ...
          <form className="flex flex-col" onSubmit={handleSubmit(onSubmit)}>
            ...
            <div className="flex flex-col mb-6">
              ...
              <input
                ...
                className=" px-2  border border-inputBorder focus-visible:outline-none  rounded-md h-10"
              />
              ...
              <div className="flex flex-row  items-center mb-2 text-base">
                <button
                  htmlFor="check"
                  className="w-132 h-19 font-dana text-xs font-semibold  text-right text-teal-500 flex-none order-2 flex-grow-0 "
                  type="submit"
                  onClick={handleRedirectToForget}
                >
            ...
            <div className="flex flex-col gap-5 w-469 h-85 flex-none order-1 self-stretch flex-grow-0 ">
              ...
              <div className="text-center">
                <button
                  className=" cursor-pointer w-full h-12 align-middle rounded-md font-dana bg-submitColor text-white"
                  id="check"
                  type="submit"
                >
                  ورود
              ...
              {/* ثبت‌نام */}
                <div className="w-159 h-25 flex flex-row-reverse justify-center items-center p-0 gap-1.5 flex-none order-1 flex-grow-0">
                  <label className="w-105 h-25 font-dana font-normal text-right text-black flex-none order-1 flex-grow-0">
                    ثبت‌نام نکرده‌ای؟
                  </label>
                  <button
                    className="w-47 h-25 font-dana font-bold text-right text-teal-500 flex-none order-0 flex-grow-0"
                    type="submit"
